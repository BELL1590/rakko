  ...
  <div class="${wrapClass}">
    <div class="header-row">
      ...
      <nav class="header-nav">
        ${
          options.admin
            ? `<a href="/admin">ダッシュボード</a><form method="post" action="/admin/logout" style="margin:0"><button class="header-logout" type="submit" style="background:none;border:1px solid rgba(255,255,255,.6);color:#fff;border-radius:999px;padding:6px 12px;min-height:32px;cursor:pointer;font-size:.85rem">ログアウト</button></form>`
